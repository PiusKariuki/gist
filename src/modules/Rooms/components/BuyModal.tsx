...
const BuyModal: React.FC<Props> = ({
	...
	return (
		<div
         ...
         min-h-screen gap-y-[2rem] py-[3rem] px-[0.5rem] items-stretch ">
			<p className="text-[1.4rem] text-center font-[700]">
				Products available for purchase
			</p>
         <FontAwesomeIcon icon={faXmark} size="2x" color="red"  className="absolute top-4 right-6"
         ...
         />
			...
			<div className="flex flex-row flex-nowrap justify-around ">
				<div
					...
					className="w-[4rem] h-4rem] bg-contain bg-no-repeat bg-center rounded-xl"
				/>
				<div className="flex flex-col">
					<p className="text-[1rem] font-[700] text-black-40 flex- flex-wrap w-[12rem]">
						{name}
					</p>
					<p className="text-[1rem] text-red-20">${price}</p>
